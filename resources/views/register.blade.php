    ...
    <div class="bg-gray-700 bg-opacity-50 p-8 rounded-lg shadow-lg w-full max-w-lg">
        ...
        <form id="registrationForm">
            <div class="mb-4">
                ...
                <input type="text" class="w-full p-2 rounded bg-gray-800 text-white border border-gray-700 focus:outline-none focus:border-blue-500">
            </div>
            <div class="mb-4">
                <label class="block text-gray-300 mb-1">Nomor NPWP Perusahaan <span class="text-red-500">*</span></label>
                <input id="npwp" type="text" class="w-full p-2 rounded bg-gray-800 text-white border border-gray-700 focus:outline-none focus:border-blue-500">
            ...
            <div class="mb-4">
                ...
                <input id="telepon" type="text" class="w-full p-2 rounded bg-gray-800 text-white border border-gray-700 focus:outline-none focus:border-blue-500">
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="email" class="w-full p-2 rounded bg-gray-800 text-white border border-gray-700 focus:outline-none focus:border-blue-500">
            </div>
            <div class="mb-4 relative">
                <label class="block text-gray-300 mb-1">Password <span class="text-red-500">*</span></label>
                <div class="flex items-center">
                    <input class="w-full p-2 rounded bg-gray-800 text-white border border-gray-700 focus:outline-none focus:border-blue-500" type="password" id="password">
